...
@property (assign, nonatomic) CGFloat                      sidesInsetValue;
@property (assign, nonatomic) BOOL                         allowTypedEntries;
@property (assign, nonatomic) NSInteger                    maxNumberOfResults;
